...
namespace Server
{
    public static class ChatController
    {
        ...
        public static void AddMessage(string userName,string msg)
        {
            ...
            catch (Exception ex) { Console.WriteLine("Error with addMessage: {0}.", ex.Message); }
        }
        ...
        public static string GetChat()
        {
            ...
            catch (Exception ex) { Console.WriteLine("Error with getChat: {0}", ex.Message); return string.Empty; }
        }
    }
}
