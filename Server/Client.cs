...
namespace Server
{
    public class Client
    {
        ...
        public void End()
        {
            ...
            catch (Exception ex) { Console.WriteLine("Error with end: {0}.",ex.Message); }
        }
        ...
        public void Send(string command)
        {
            ...
            catch (Exception ex) { Console.WriteLine("Error with send command: {0}.", ex.Message); Server.EndClient(this); }
        }
    }
}
